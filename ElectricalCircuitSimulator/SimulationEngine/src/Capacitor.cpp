...
namespace SimulationEngine {
    ...
    void Capacitor::applyConductanceMatrixStamp(Matrix<double>& oConductanceMatrix, const double dTimeStep) {
        double dResistance;
    ...
    void Capacitor::applySourceVectorMatrixStamp(Matrix<double>& oSourceVector) {
        double dCurrent;
    ...
    void Capacitor::step(Matrix<double>& oSourceVector) { // Trapezoidal integration
        applySourceVectorMatrixStamp(oSourceVector);
    }

    void Capacitor::postStep(Matrix<double>& oVoltageMatrix) {
